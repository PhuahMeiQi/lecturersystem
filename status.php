<?php
	...
	if(isset($_POST['approve'])){
		...
		$sql = "UPDATE status SET 
				...
				status".$_POST['statusid']."='Approved'
	...
	if(isset($_POST['reject'])){
		...
		$sql = "UPDATE status SET 
				...
				status".$_POST['statusid']."='Rejected'
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="ml-xl-3 login"><a href="c_password.php"><span class="border-left pl-xl-4"></span>Change Password</a></li>
    ...
    <div class="site-section bg-light">
      <div class="container">
        ...
        <div class="overlap-category mb-s">
			...
			<?php
				...
				if($row){
					...
					<div class='row'>
						...
						$sql1 = "SELECT * FROM academic WHERE user_id = ".$_GET['id']." ORDER BY year_award DESC";
						...
						$sql2 = "SELECT * FROM experience WHERE user_id='".$_GET['id']."' AND type='teaching' ORDER BY d_to DESC";
						...
						$sql2 = "SELECT * FROM experience WHERE user_id='".$_GET['id']."' AND type='industrial' ORDER BY d_to DESC";
						$query2 = mysqli_query($con,$sql2);
						...
						$sql3 = "SELECT * FROM status WHERE user_id = ".$_GET['id'];
									...
									echo "
										<td>
										  ...
										  <div class='row no-gutters'>
											...
											<div class='col-xl-3'>
												<form action='status.php?id=".$_GET['id']."' method='post'>
													<input type='hidden' name='statusid' value=1>
													<input type='submit' name='approve' value='Approve' class='btn btn-primary py-2 px-4 text-white' style='width:120px;'>
													<input type='submit' name='reject' value='Reject' class='btn btn-danger py-2 px-4 text-white' style='width:120px;'>
												</form>
											</div>
			...
			<br><br>
			<center><button onclick="window.location.href='dhome.php';" class="btn btn-primary py-2 px-4 text-white">Back</button></center>
			<br><br><br>
